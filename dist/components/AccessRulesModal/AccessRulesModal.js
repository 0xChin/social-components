...
export default function AccessRulesModal({
  hide,
  callbackNftUpdate,
  accessRules
}) {
...
const OneAccessRule = ({
  ...
  switch (accessRule.type) {
    case "credential":
      return /*#__PURE__*/React.createElement("div", {
        className: styles.accessRuleContainer,
        style: {
...
const PoapDetails = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: styles.poapDetailsContainer
  }, /*#__PURE__*/React.createElement("img", {
    className: styles.poapDetailsContainerLogo,
...
const AccessRuleToken = ({
  ...
  }, requiredToken?.minBalance, " ", requiredToken?.symbol, " ", requiredToken?.token_id && /*#__PURE__*/React.createElement("small", {
    style: {
      marginLeft: 4,
      marginRight: 4
    }
  }, "(ID: ", requiredToken.token_id, ")"), " on ", /*#__PURE__*/React.createElement(ChainLogo, {
    chain: requiredToken?.chain,
    address: requiredToken?.address
  }));
};
