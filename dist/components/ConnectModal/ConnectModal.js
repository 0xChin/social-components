...
export default function ConnectModal({
  ...
  return /*#__PURE__*/React.createElement(Modal, {
    ...
    lit: lit,
    type: "google",
    label: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(GoogleIcon, {
      className: "mr-2"
    }), " Google"),
    bg: "#F2F2F2",
    hoverColor: "#FFFFFF",
...
function GoogleLoginCustom({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "flex flex-row cursor-pointer bg-white hover:bg-slate-100 px-5 py-2 rounded-lg shadow"
  }, loading ? /*#__PURE__*/React.createElement("span", {
    className: `text-base text-gray-900 font-medium`
  }, "Loading...") : /*#__PURE__*/React.createElement("span", {
    className: `text-base text-gray-900 font-medium flex flex-row items-center`,
    onClick: login
  }, /*#__PURE__*/React.createElement("img", {
    src: "/icons/google.png",
    className: "h-4 mr-2"
  }), /*#__PURE__*/React.createElement("span", null, "Login with Google")));
}
const MetamaskIcon = ({
  className
}) => {
