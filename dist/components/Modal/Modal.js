...
export default function Modal({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    ref: wrapperRef,
    style: {
      background: theme?.bg?.main ? theme.bg.main : defaultTheme.bg.main,
      width: width,
      maxHeight: '85vh',
      top: 15,
      overflow: "scroll"
...
const WalletButton = ({
  ...
  return /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: `mt-3 inline-flex items-center w-full justify-center rounded-full border border-transparent px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-[${hoverColor}] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 text-center`,
    style: {
      background: bg
    },
    onClick: () => connect()
